        ...
        <Box h={"100vh"} minH={"100vh"} w={"100vw"} minW={"100vw"}>
            ...
            >
                ...
                <Box w={isMobile ? "100%" : "80%"} h="75%" bg="black" borderRadius={10} p={5} color="white" overflow={"scroll"}>
                    ...
                    <Text align="center" >I am also a developer of <Link href="https://app.riffitnow.com" color={"#85bfee"} target="_blank" rel="noreferrer">RIFFIT Reader</Link> and <Link href="https://app.songr.ai" color={"#d87559"} target="_blank" rel="noreferrer">SongR</Link>, working on its multi-genre AI powered algorithmic composition system, digital instrument collection, and dynamic mixing interface.</Text><br />
